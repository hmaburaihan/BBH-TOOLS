# python3
# Author  : ABU RAIHAN 
# Github  : https://github.com/hmaburaihan
...
\033[43m\033[1;91m[Programmed By BBH]
\033[43m\033[1;91m[WhatsApp : +88013144374XX
\033[43m\033[1;91m[Facebook : Abu Raihan
...
#def about():
    ...
    print(logo)
    print(yellow+'╔═══════════════════════════════════════════════╗')
    print(yellow+'║'+cyan+'[ Tools ]     '+purple+' :'+green+'BBH                      '+yellow+'   ║')              
    print(yellow+'║'+cyan+'[ Version ]   '+purple+' :'+green+'[1.0]                       '+yellow+'   ║')
    print(yellow+'║'+cyan+'[ Author ]    '+purple+' :[ABU RAIHAN] ')
    print(yellow+'║'+cyan+'[ Github ]    '+purple+' :[https://github.com/hmaburaihan] ')
    print(cyan+' ║[Facebook ] '+purple+' :[Abu Raihan]')
    print(cyan+' ║[Email]     '+purple+' :[best11hackers@gmail.com]\n')
    print('\n[01] Main Menu')
    print('[02] Exit')
    ...
    while True:
        if choose == "1" or choose=="01":
            ...
            if os.path.exists("/data/data/com.termux/files/home"):
                os.system('xdg-open --view  https://www.facebook.com/groups/452215046996439/?ref=share')
                ret=input(white+"\nENTER TO BACK > "+green)
            main()    
   #         else:
